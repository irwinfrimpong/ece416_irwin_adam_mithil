...
set_property -dict { PACKAGE_PIN J13   IOSTANDARD LVCMOS33 } [get_ports { oerr }]; #IO_L17N_T2_A25_15 Sch=led[2]
...
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { rdy }]; #IO_L4N_T0_D05_14 Sch=btnu
